(function () {
	BX.namespace('BX.iTrack.Chart.BlockList');

	BX.iTrack.Chart.BlockList = {
		gridId: null,
		grid: null,
		sign: '',
		...
		newBlock: function () {
			window.BX24.openApplication({
				...
				bx24_width: 550,
				sign: this.sign,
				"signedParams": this.signedParamsEdit,
		...
		delete: function(id) {
			let popup = new BX.UI.Dialogs.MessageBox(
				{
					title: 'Удаление',
					message: 'Вы действительно хотите удалить выбранный блок?',
					modal: true,
